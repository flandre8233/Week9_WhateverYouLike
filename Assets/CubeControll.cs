...
public class CubeControll : SingletonMonoBehavior<CubeControll>
{
    ...
    {
        return (FloorControll.instance.GetCurrentFloor() * 5) - 0;
    }
    ...
    public void Clear(GameObject Obj)
    {
        ...
        Destroy(Obj.GetComponent<PlayerOverridedRotate>());
        List.Remove(Obj);
        OnClear();
    }
